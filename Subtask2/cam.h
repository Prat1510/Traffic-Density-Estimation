...
Mat angle_correction(Mat image)
{
    ...
    pts_src.push_back(Point2f(957,254));
    pts_src.push_back(Point2f(558,1066));
    pts_src.push_back(Point2f(1526,1066));
    pts_src.push_back(Point2f(1276,242));
    // namedWindow("Original Frame", WNDOW_AUTOSIZE);           //taking the source points from mouse click
    ...
    // waitKey(0);
    // imwrite("cropped.jpg", t_out_cropped);
